  ...
  return (
    <>
      ...
      <PageMain className="grid gap-4 pt-4 lg:grid-cols-2 lg:items-start">
        {/* Foco do dia ------------------------------------------------------ */}
        <section aria-labelledby="foco" className="min-w-0 lg:col-span-2">
          <SectionTitle
        ...
        {/* Rotina + Estudo, lado a lado como no kit ------------------------- */}
        ...
        <div className="grid min-w-0 grid-cols-[minmax(0,1fr)_auto] gap-3 lg:col-span-2 lg:grid-cols-[minmax(0,1fr)_240px]">
          <Card>
          ...
          <Card className="w-[152px] min-w-0 lg:w-auto">
        ...
        {snapshot.classesToday.length > 0 && (
          <section aria-labelledby="aulas" className="min-w-0 lg:col-span-2">
        ...
        {snapshot.upcoming.length > 0 && (
          <section aria-labelledby="proximos" className="min-w-0 lg:col-span-2">
            <SectionTitle
              action={
                <Link
                  href="/agenda"
