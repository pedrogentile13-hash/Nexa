...
/**
 * O onboarding de quem estuda na ESCOLA, em cinco telas curtas.
 *
 * Quem escolheu a jornada do vestibular não passa por aqui — vai pro
 * `VestibularOnboardingFlow`, que pergunta outras coisas. Este arquivo é o
 * fluxo original, intocado: a bifurcação por jornada foi feita acrescentando
 * um caminho, não reescrevendo o que já funcionava.
 *
...
export function SchoolOnboardingFlow({ catalog, coreSubjectIds, defaultName, fallbackTimezone }: Props) {
